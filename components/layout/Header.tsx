...
export default function Header() {
  ...
  return (
    <header
      ...
      style={{ height: '56px', background: '#0b0002', borderBottom: '1px solid #370006' }}
    >
            ...
            link.hasDropdown ? (
              ...
              <div key={link.label} className="relative group">
                ...
                <div
                  ...
                  style={{ background: '#180003', border: '1px solid #370006', boxShadow: '0 8px 24px rgba(0,0,0,0.5)' }}
                >
      ...
      {/* Mobile drawer */}
      {isNavOpen && (
        <div className="lg:hidden fixed inset-0 top-14 bg-[#0b0002] z-40 overflow-y-auto">
